...
public class UserListTest {
    ...
    void testAvfFirstMoreThanSecondAvg() {
        ...
        assertEquals("Второй список имеет большее среднее значение", userList.compareAvgValueLists(userList.firstList, userList.secondList));
    }
    ...
    void testAvfFirstLessThanSecondAvg() {
        ...
        assertEquals("Первый список имеет большее среднее значение", userList.compareAvgValueLists(userList.firstList, userList.secondList));
    }
